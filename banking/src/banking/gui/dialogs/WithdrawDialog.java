...
public class WithdrawDialog extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1989437455316739541L;
	 ...
	 * @param bank 
	 */
	public WithdrawDialog(Bank bank) {
		...
		getContentPane().add(contentPanel, BorderLayout.CENTER);
		{
			...
			{
				JButton okButton = new JButton("Withdraw");
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							bank.withdrawMoney(personId, accountId, sum);
							Panel.refreshTable();
							setVisible(false);
