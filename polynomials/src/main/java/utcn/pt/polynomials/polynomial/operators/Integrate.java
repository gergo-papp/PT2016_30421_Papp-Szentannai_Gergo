...
public class Integrate implements UnaryOperator {
	...
	public Polynom compute(Polynom A) {
		...
		for (int i = 0; i < nrOfMonoms; i++) {
			...
			coeff[i][0] = A.getMonom(i)[1] * 1/(A.getMonom(i)[0]+1);
			System.out.println("term " + i + "; " + A.getMonom(i)[1] + "x^" + A.getMonom(i)[1] + ", integrated term: "
